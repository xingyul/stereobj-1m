...
import renderer.cuda.create_texture_image as create_texture_image_cuda
...
def create_texture_image(textures, texture_size_out=16):
    ...
    image = torch.zeros(tile_height * texture_size_out,
                        tile_width * texture_size_out,
                        3,
                        dtype=torch.float32)
    vertices = torch.zeros((num_faces, 3, 2),
                           dtype=torch.float32)  # [:, :, XY]
